...
func (m *mockTemplateService) Create(ctx context.Context, req template.TemplateCreateRequest) (*template.Template, error) {
...
func (m *mockTemplateService) GetByID(ctx context.Context, id uuid.UUID) (*template.Template, error) {
	args := m.Called(ctx, id)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *mockTemplateService) List(ctx context.Context, limit, offset int) ([]*template.Template, int64, error) {
	args := m.Called(ctx, limit, offset)
	if args.Get(0) == nil {
		return nil, args.Get(1).(int64), args.Error(2)
	}
	return args.Get(0).([]*template.Template), args.Get(1).(int64), args.Error(2)
}

func (m *mockTemplateService) Update(ctx context.Context, id uuid.UUID, req template.TemplateUpdateRequest) (*template.Template, error) {
